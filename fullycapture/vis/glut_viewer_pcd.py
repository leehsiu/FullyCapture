...
class GLUTviewer:
	...
	def mainloop(self):
		...
		vt0 = np.loadtxt('/home/xiul/databag/dome_sptm/171204_pose6/dp_pcd_ransac/pcd_{:08d}_001.txt'.format(self.frameId+500))

		vt1 = np.loadtxt('/home/xiul/databag/dome_sptm/171204_pose6/dp_pcd_xiu/pcd_{:08d}_000.txt'.format(self.frameId+500))

		for vv in vt1:
			if vv[0]>0:
				v_smpl = vts[int(vv[0])]
				#print(self.trans[self.frameId])
				vv_t = vv[1:] - self.trans[self.frameId]
				self.easyCone(vv_t.ravel(),v_smpl,10,[0.0,1.0,0.0,1.0])
