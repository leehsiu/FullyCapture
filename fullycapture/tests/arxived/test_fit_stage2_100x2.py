...
#load init
	...
	optimizer = torch.optim.SGD([{'params':betas_delta_cu,'lr':1e-2},
                                  {'params':delta_thetas_cu,'lr':1e-2},
	...
	with open('stage2_with_pose.pkl','wb') as fio:
		pickle.dump({'pose':thetas_cu_batch_cpu,'betas':betas_cu_batch_cpu,'trans':trans_cu_batch_cpu},fio)

	np.savetxt('stage2_texture_framed_interg_100x2.txt',cano_tex_cpu)
