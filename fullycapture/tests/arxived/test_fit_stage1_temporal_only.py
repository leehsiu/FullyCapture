...
if __name__=='__main__':
    ...
    joints_path = '/media/internal/domedb/171204_pose3/hdPose3d_total'
    ...
    frame_range = range(400-138,400-138+300)
    joints_total = []
    ...
    for frame_id in range(400,700):
        v_3d,v_weight = dataIO.load_dp_vts_3d('/home/xiul/databag/dome_sptm/171204_pose3/dp_pcd_ransac',frame_id,1)
    ...
    with open('./stage0_171204_pose3.pkl') as fio:
        dd = pickle.load(fio)
    ...
    for start_id in range(0,300,100):
        init_param = {'betas':dd['betas'][0],'thetas':dd['pose'][start_id:start_id+100],'trans':dd['trans'][start_id:start_id+100]}
        betas_n,thetas_n,trans_n = capUtils.fit_stage1_spatial_temporal(joints_total[start_id:start_id+100,:,:3],joints_total[start_id:start_id+100,:,3],vts_total[start_id:start_id+100,:,:],vts_weight[start_id:start_id+100,:,:],init_param,n_iter=400)
    ...
    with open('stage1_temporal_171204_pose3.pkl','wb') as fio:
