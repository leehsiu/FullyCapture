...
def simple_renderer(rn, verts, faces, vc=None, yrot=np.radians(120), lighting=False):
...
def render_model(verts, faces, w, h, cam, near=0.5, far=25, vc=None, img=None,lighting=False):
    rn = _create_renderer(
    ...
    imtmp = simple_renderer(rn, verts, faces, vc, lighting=lighting)
